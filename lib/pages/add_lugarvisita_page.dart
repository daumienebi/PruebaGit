        ...
        child: Expanded(
          child: Column(
            children: [
              ...
              GestureDetector(
                  onTap: () async {
                    LugarVisita lugarVisita = LugarVisita(
                        nombre: cntlNombre.text,
                        descripcion: cntlDesc.text,
                        coordenada: cntlCoord.text);
                    //print("${lugarVisita.nombre} ${lugarVisita.descripcion}");
                    try {
                      await LugarVisitaDatabase.instance
                          .crearLugarVisita(lugarVisita);
                      print("Lugar añadido");
